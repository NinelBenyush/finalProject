    ...
    <div>
      ...
      <div className="flex items-center justify-center h-screen bg-gray-100">
        ...
        <div className="lg:p-36 md:p-52 sm:20 p-8 w-full lg:w-1/2">
          ...
          <button onClick={() => sendLogin()} className="bg-emerald-500 text-white py-2 px-4 rounded hover:bg-emerald-200 transition-colors duration-300 w-full">
            Submit
          </button>
          {loading && <div className="mt-4 flex space-x-2"><span className="loading loading-spinner text-success"></span></div>}
